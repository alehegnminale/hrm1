...
<main class="main-content">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" id="first_name" name="first_name" class="form-control" 
                   value="{{ old('first_name', $profile->first_name ?? '') }}" required autocomplete="given-name">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" id="middle_name" name="middle_name" class="form-control" 
                   value="{{ old('middle_name', $profile->middle_name ?? '') }}" required autocomplete="additional-name">
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" id="last_name" name="last_name" class="form-control" 
                   value="{{ old('last_name', $profile->last_name ?? '') }}" required autocomplete="family-name">
    ...
    <div class="form-group">
        ...
        <select id="martial_status" name="martial_status" class="form-control" required autocomplete="status">
            <option value="">Select Marital Status</option>
            <option value="single" {{ (old('martial_status', $profile->martial_status ?? '') == 'single') ? 'selected' : '' }}>Single</option>
            <option value="married" {{ (old('martial_status', $profile->martial_status ?? '') == 'married') ? 'selected' : '' }}>Married</option>
            <option value="divorced" {{ (old('martial_status', $profile->martial_status ?? '') == 'divorced') ? 'selected' : '' }}>Divorced</option>
            <option value="widowed" {{ (old('martial_status', $profile->martial_status ?? '') == 'widowed') ? 'selected' : '' }}>Widowed</option>
        </select>
    ...
    <div class="form-group">
        ...
        <input type="number" id="age" name="age" class="form-control" 
               value="{{ old('age', $profile->age ?? '') }}" required autocomplete="age">
        @if ($errors->has('age'))
    ...
    <div class="form-group">
    <label for="phone_number">Phone Number (without +251)</label>
    <input type="text" id="phone_number" name="phone_number" class="form-control" 
           value="{{ old('phone_number', substr($profile->phone_number ?? '', 4)) }}" 
           placeholder="Ex: 912345678" required autocomplete="tel">
